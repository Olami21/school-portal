...
export default function PrintResultPage() {
  ...
  const handleGenerate = async () => {
    ...
    // Find this student's class enrollment (via the term's session)
    ...
    // Class Highest: for each subject this student took, find the max total
    // among all students in the same class for that subject+term.
    ...
    // Load teacher's comment if one exists
